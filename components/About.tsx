  ...
  return (
    <section id="about" className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4">
        {/* Heading */}
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center text-gray-900 mb-6 tracking-wide">
          ABOUT US
        </h2>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 border-t border-l border-gray-300">
            {services.slice(0, 3).map((service, index) => (
              ...
              >
                <h3 className="text-sm md:text-base font-semibold tracking-widest text-gray-900 mb-4">
                  {service.title}
                </h3>
